 ...
 */
class LodgingSuggestionAdapter(private var context: Activity, private var items: ArrayList<Hotel>): BaseAdapter() {
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        if(convertView == null){
            ...
            view = inflater.inflate(R.layout.adventure_hotel_suggestion_list_item, null)
